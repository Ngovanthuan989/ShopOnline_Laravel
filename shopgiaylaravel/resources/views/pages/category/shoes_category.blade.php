...
<div class="head-bread">
            <div class="container">
                <ol class="breadcrumb">
                    ...
                    <li class="active">{{$cate_name->category_name}}</li>
                    @endforeach
                </ol>
            </div>
        </div>
                            ...
                            <div class="ih-item square effect3 bottom_to_top">
                                ...
                                <div class="info">
                                    ...
                                    <div class="pull-right styl-price">
                                        <p><a  href="#" class="item_add"><span class="glyphicon glyphicon-shopping-cart grid-cart" aria-hidden="true"></span> <span class=" item_price">{{number_format($cate->product_price).''.'VNĐ'}}</span></a></p>
                                    </div>
